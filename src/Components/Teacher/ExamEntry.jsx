...
import { useState, useEffect } from 'react';
import { useParams, useNavigate } from 'react-router-dom';
import { Save, X, Loader2, Edit, Trash2, Plus } from 'lucide-react';
import { motion } from 'framer-motion';
import { collection, getDocs, doc, setDoc, deleteDoc, query, where } from 'firebase/firestore';
import { firestore } from '../../Firebase/config';
import { toast } from 'sonner';
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-12 gap-2 items-center mt-4">
                  <input
                    ...
                    className="col-span-8 sm:col-span-7 p-2 rounded-md border border-gray-300 text-sm focus:ring-[#3D4577] focus:border-[#3D4577]"
                  />
                  <button
                    type="button"
                    onClick={handleAddSubject}
                    className="col-span-4 sm:col-span-3 flex items-center justify-center gap-1 text-sm bg-blue-100 text-blue-700 p-2 rounded-md hover:bg-blue-200"
                  >
